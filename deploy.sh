...
echo ""
echo -e "${BOLD}OPTIONAL — Web Dashboard${NC}"
echo -e "  Deploy toolsdns-web to Vercel for a browser-based dashboard."
[[ -n "$PUBLIC_URL" ]] && {
echo -e "  Set these env vars in Vercel:"
echo -e "    TOOLDNS_API_URL=${PUBLIC_URL}"
echo -e "    TOOLDNS_API_KEY=${API_KEY}"
}
echo -e "  Or skip it — tooldns.sh covers all management tasks from the CLI."
echo ""
